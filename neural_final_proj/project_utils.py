...
def prepare_data_loaders(data_root, image_size, batch_size, train_dir='train', valid_dir='valid'):
    ...
    # NOTE: Assumes folder names are 'train' and 'valid' (or passed via valid_dir)
...
# --- Interpretability Classes ---

# --- Replacement for visualize_saliency_map in project_utils.py ---
...
class GradCAM:
    ...
    def close(self):
        ...
        # Assuming your hooks are saved as self.hook_a and self.hook_g
        self.hook_a.remove()
        self.hook_g.remove()
